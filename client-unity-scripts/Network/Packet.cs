...
namespace FantasyRealm.Network
{
    public enum PacketType : ushort
    {
        ...
        C_RENTAL_LIST=0x95, S_RENTAL_LIST=0x96, C_RENTAL_RENT=0x97, S_RENTAL_RESULT=0x98,
        C_CHEST_LIST=0x99, S_CHEST_LIST=0x9A, C_CHEST_STORE=0x9B, C_CHEST_TAKE=0x9C,
        C_CHEST_BUY=0x9D, S_CHEST_CONTENT=0x9E, C_CHEST_OPEN=0x84,
        C_FURNITURE_USE=0x85, S_FURNITURE_EFFECT=0x86,
