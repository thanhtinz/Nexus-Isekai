...
public class PacketDispatcher {
    ...
    public void init() {
        ...
        // Housing / nhà ở
        handlers.put(PacketType.C_HOUSE_LIST,      housing::onListHouses);
        handlers.put(PacketType.C_HOUSE_BUY,       housing::onBuyHouse);
        handlers.put(PacketType.C_HOUSE_ENTER,     housing::onEnterHouse);
