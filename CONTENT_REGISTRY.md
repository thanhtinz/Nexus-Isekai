...
| `quest` | 9xxx | `Sprites/Quest/` | Vật phẩm nhiệm vụ/sự kiện |

## B. CONTENT BẢNG RIÊNG (mỗi bảng id tự tăng TỪ 1)
...
| 🪑 Nội thất | `furniture_catalog` | `Sprites/Furniture/` | `furniture_type` |
