...
-- ─────────────────────────────────────────
-- 8. SKILL SYSTEM EXTENDED (20 skills/class, 5 active)
-- ─────────────────────────────────────────
...
CREATE TABLE IF NOT EXISTS character_skill_slots (
    char_id      BIGINT NOT NULL,
    slot_index   TINYINT NOT NULL,  -- 0-4 (5 skill slots)
...
INSERT IGNORE INTO class_templates (id,name,name_en,base_hp,base_mp,base_str,base_agi,base_intel,base_vit,hp_per_level,mp_per_level,starter_weapon_id,first_quest_id,sort_order) VALUES
(1,'Kiếm Sĩ','Swordsman',250,100,15,10,5,12,20,10,1,1,1),
(2,'Pháp Sư','Mage',150,200,5,10,18,8,10,15,3,2,2),
(3,'Xạ Thủ','Gunner',190,120,10,16,9,9,14,10,5,3,3),
(4,'Slinger','Slinger',180,120,9,17,10,8,13,11,6,4,4),
(5,'Axeman','Axeman',270,90,18,7,5,14,22,8,7,5,5),
(6,'Quyền Sư','Brawler',230,110,14,14,6,12,18,10,8,6,6),
(7,'Cung Thủ','Archer',200,130,8,16,10,10,15,11,4,7,7),
(8,'Sát Thủ','Assassin',180,120,12,18,8,8,14,12,2,8,8);
...
(101,'Chém Mạnh',1,'active','none',100,8,1500,10,'Chém Mạnh',1001,1),
(102,'Đột Kích',1,'active','none',112,10,1700,10,'Đột Kích',1002,3),
(103,'Xoáy Kiếm',1,'active','none',124,12,1900,10,'Xoáy Kiếm',1003,5),
(104,'Kiếm Khí',1,'active','none',136,14,2100,10,'Kiếm Khí',1004,7),
(105,'Trảm Phong',1,'active','none',148,16,2300,10,'Trảm Phong',1005,9),
(106,'Long Trảm',1,'active','none',160,18,2500,10,'Long Trảm',1006,11),
(107,'Phá Giáp',1,'active','none',172,20,2700,10,'Phá Giáp',1007,13),
(108,'Liên Trảm',1,'active','none',184,22,2900,10,'Liên Trảm',1008,15),
(109,'Cuồng Phong Kiếm',1,'active','none',196,24,3100,10,'Cuồng Phong Kiếm',1009,17),
(110,'Thiên Kiếm',1,'active','none',208,26,3300,10,'Thiên Kiếm',1010,19),
(111,'Kiếm Vũ',1,'active','none',220,28,3500,10,'Kiếm Vũ',1011,21),
(112,'Bạch Long Trảm',1,'active','none',232,30,3700,10,'Bạch Long Trảm',1012,23),
(113,'Hộ Thuẫn',1,'active','none',244,32,3900,10,'Hộ Thuẫn',1013,25),
(114,'Phòng Thủ',1,'active','none',256,34,4100,10,'Phòng Thủ',1014,27),
(115,'Khí Huyết',1,'passive','none',0,0,0,10,'Khí Huyết',1015,1),
(116,'Hồi Phục',1,'passive','none',0,0,0,10,'Hồi Phục',1016,6),
(117,'Cường Thân',1,'passive','none',0,0,0,10,'Cường Thân',1017,11),
(118,'Kiên Cường',1,'passive','none',0,0,0,10,'Kiên Cường',1018,16),
(119,'Chiến Thần',1,'ultimate','none',500,90,30000,10,'Chiến Thần',1019,25),
(120,'Vô Song Kiếm',1,'ultimate','none',650,110,30000,10,'Vô Song Kiếm',1020,30),
(201,'Quả Cầu Lửa',2,'active','fire',100,8,1500,10,'Quả Cầu Lửa',2001,1),
(202,'Băng Kết',2,'active','fire',112,10,1700,10,'Băng Kết',2002,3),
(203,'Sét Đánh',2,'active','fire',124,12,1900,10,'Sét Đánh',2003,5),
(204,'Bão Lửa',2,'active','fire',136,14,2100,10,'Bão Lửa',2004,7),
(205,'Mưa Băng',2,'active','fire',148,16,2300,10,'Mưa Băng',2005,9),
(206,'Lôi Đình',2,'active','fire',160,18,2500,10,'Lôi Đình',2006,11),
(207,'Hoả Ngục',2,'active','fire',172,20,2700,10,'Hoả Ngục',2007,13),
(208,'Băng Phong',2,'active','fire',184,22,2900,10,'Băng Phong',2008,15),
(209,'Lốc Sét',2,'active','fire',196,24,3100,10,'Lốc Sét',2009,17),
(210,'Thiên Hoả',2,'active','fire',208,26,3300,10,'Thiên Hoả',2010,19),
(211,'Tinh Vân',2,'active','fire',220,28,3500,10,'Tinh Vân',2011,21),
(212,'Hư Không',2,'active','fire',232,30,3700,10,'Hư Không',2012,23),
(213,'Trí Tuệ',2,'active','fire',244,32,3900,10,'Trí Tuệ',2013,25),
(214,'Tiết Kiệm MP',2,'active','fire',256,34,4100,10,'Tiết Kiệm MP',2014,27),
(215,'Hồi MP',2,'passive','none',0,0,0,10,'Hồi MP',2015,1),
(216,'Khiên Nguyên Tố',2,'passive','none',0,0,0,10,'Khiên Nguyên Tố',2016,6),
(217,'Tăng Phép',2,'passive','none',0,0,0,10,'Tăng Phép',2017,11),
(218,'Linh Mẫn',2,'passive','none',0,0,0,10,'Linh Mẫn',2018,16),
(219,'Thảm Hoạ Lửa',2,'ultimate','fire',500,90,30000,10,'Thảm Hoạ Lửa',2019,25),
(220,'Diệt Thế Phù',2,'ultimate','fire',650,110,30000,10,'Diệt Thế Phù',2020,30),
(301,'Liên Phát',3,'active','none',100,8,1500,10,'Liên Phát',3001,1),
(302,'Xuyên Phá',3,'active','none',112,10,1700,10,'Xuyên Phá',3002,3),
(303,'Đạn Nổ',3,'active','none',124,12,1900,10,'Đạn Nổ',3003,5),
(304,'Bắn Tỉa',3,'active','none',136,14,2100,10,'Bắn Tỉa',3004,7),
(305,'Xối Đạn',3,'active','none',148,16,2300,10,'Xối Đạn',3005,9),
(306,'Đạn Xuyên',3,'active','none',160,18,2500,10,'Đạn Xuyên',3006,11),
(307,'Hoả Lực',3,'active','none',172,20,2700,10,'Hoả Lực',3007,13),
(308,'Súng Máy',3,'active','none',184,22,2900,10,'Súng Máy',3008,15),
(309,'Đạn Lửa',3,'active','none',196,24,3100,10,'Đạn Lửa',3009,17),
(310,'Càn Quét',3,'active','none',208,26,3300,10,'Càn Quét',3010,19),
(311,'Pháo Kích',3,'active','none',220,28,3500,10,'Pháo Kích',3011,21),
(312,'Tán Xạ',3,'active','none',232,30,3700,10,'Tán Xạ',3012,23),
(313,'Nạp Đạn',3,'active','none',244,32,3900,10,'Nạp Đạn',3013,25),
(314,'Mắt Ngắm',3,'active','none',256,34,4100,10,'Mắt Ngắm',3014,27),
(315,'Né Lùi',3,'passive','none',0,0,0,10,'Né Lùi',3015,1),
(316,'Áo Giáp',3,'passive','none',0,0,0,10,'Áo Giáp',3016,6),
(317,'Tăng Tốc',3,'passive','none',0,0,0,10,'Tăng Tốc',3017,11),
(318,'Chính Xác',3,'passive','none',0,0,0,10,'Chính Xác',3018,16),
(319,'Bão Đạn',3,'ultimate','none',500,90,30000,10,'Bão Đạn',3019,25),
(320,'Tử Thần Súng',3,'ultimate','none',650,110,30000,10,'Tử Thần Súng',3020,30),
(401,'Ná Liên Hoàn',4,'active','none',100,8,1500,10,'Ná Liên Hoàn',4001,1),
(402,'Đạn Đá',4,'active','none',112,10,1700,10,'Đạn Đá',4002,3),
(403,'Bi Sắt',4,'active','none',124,12,1900,10,'Bi Sắt',4003,5),
(404,'Bắn Cong',4,'active','none',136,14,2100,10,'Bắn Cong',4004,7),
(405,'Đạn Keo',4,'active','none',148,16,2300,10,'Đạn Keo',4005,9),
(406,'Bi Nổ',4,'active','none',160,18,2500,10,'Bi Nổ',4006,11),
(407,'Bắn Loạt',4,'active','none',172,20,2700,10,'Bắn Loạt',4007,13),
(408,'Đạn Độc',4,'active','none',184,22,2900,10,'Đạn Độc',4008,15),
(409,'Treo Bẫy',4,'active','none',196,24,3100,10,'Treo Bẫy',4009,17),
(410,'Đạn Băng',4,'active','none',208,26,3300,10,'Đạn Băng',4010,19),
(411,'Bi Lửa',4,'active','none',220,28,3500,10,'Bi Lửa',4011,21),
(412,'Bắn Vọt',4,'active','none',232,30,3700,10,'Bắn Vọt',4012,23),
(413,'Lắp Đạn',4,'active','none',244,32,3900,10,'Lắp Đạn',4013,25),
(414,'Mắt Tinh',4,'active','none',256,34,4100,10,'Mắt Tinh',4014,27),
(415,'Lăn Né',4,'passive','none',0,0,0,10,'Lăn Né',4015,1),
(416,'Da Dày',4,'passive','none',0,0,0,10,'Da Dày',4016,6),
(417,'Nhanh Nhẹn',4,'passive','none',0,0,0,10,'Nhanh Nhẹn',4017,11),
(418,'Tinh Mắt',4,'passive','none',0,0,0,10,'Tinh Mắt',4018,16),
(419,'Cơn Mưa Bi',4,'ultimate','none',500,90,30000,10,'Cơn Mưa Bi',4019,25),
(420,'Sát Thủ Ná',4,'ultimate','none',650,110,30000,10,'Sát Thủ Ná',4020,30),
(501,'Bổ Rìu',5,'active','none',100,8,1500,10,'Bổ Rìu',5001,1),
(502,'Chém Ngang',5,'active','none',112,10,1700,10,'Chém Ngang',5002,3),
(503,'Xoay Rìu',5,'active','none',124,12,1900,10,'Xoay Rìu',5003,5),
(504,'Đập Đất',5,'active','none',136,14,2100,10,'Đập Đất',5004,7),
(505,'Cuồng Chém',5,'active','none',148,16,2300,10,'Cuồng Chém',5005,9),
(506,'Phá Sơn',5,'active','none',160,18,2500,10,'Phá Sơn',5006,11),
(507,'Long Trời',5,'active','none',172,20,2700,10,'Long Trời',5007,13),
(508,'Rìu Bay',5,'active','none',184,22,2900,10,'Rìu Bay',5008,15),
(509,'Chấn Địa',5,'active','none',196,24,3100,10,'Chấn Địa',5009,17),
(510,'Huyết Chiến',5,'active','none',208,26,3300,10,'Huyết Chiến',5010,19),
(511,'Lốc Rìu',5,'active','none',220,28,3500,10,'Lốc Rìu',5011,21),
(512,'Thiên Phủ',5,'active','none',232,30,3700,10,'Thiên Phủ',5012,23),
(513,'Cuồng Nộ',5,'active','none',244,32,3900,10,'Cuồng Nộ',5013,25),
(514,'Da Thép',5,'active','none',256,34,4100,10,'Da Thép',5014,27),
(515,'Bất Khuất',5,'passive','none',0,0,0,10,'Bất Khuất',5015,1),
(516,'Hồi Sinh',5,'passive','none',0,0,0,10,'Hồi Sinh',5016,6),
(517,'Sức Trâu',5,'passive','none',0,0,0,10,'Sức Trâu',5017,11),
(518,'Kiên Định',5,'passive','none',0,0,0,10,'Kiên Định',5018,16),
(519,'Phá Thiên Phủ',5,'ultimate','none',500,90,30000,10,'Phá Thiên Phủ',5019,25),
(520,'Huỷ Diệt',5,'ultimate','none',650,110,30000,10,'Huỷ Diệt',5020,30),
(601,'Đấm Thẳng',6,'active','none',100,8,1500,10,'Đấm Thẳng',6001,1),
(602,'Liên Hoàn Quyền',6,'active','none',112,10,1700,10,'Liên Hoàn Quyền',6002,3),
(603,'Cước Phong',6,'active','none',124,12,1900,10,'Cước Phong',6003,5),
(604,'Thiết Đầu',6,'active','none',136,14,2100,10,'Thiết Đầu',6004,7),
(605,'Trảo Long',6,'active','none',148,16,2300,10,'Trảo Long',6005,9),
(606,'Băng Quyền',6,'active','none',160,18,2500,10,'Băng Quyền',6006,11),
(607,'Hổ Quyền',6,'active','none',172,20,2700,10,'Hổ Quyền',6007,13),
(608,'Liên Cước',6,'active','none',184,22,2900,10,'Liên Cước',6008,15),
(609,'Xoáy Quyền',6,'active','none',196,24,3100,10,'Xoáy Quyền',6009,17),
(610,'Long Trảo',6,'active','none',208,26,3300,10,'Long Trảo',6010,19),
(611,'Bạo Quyền',6,'active','none',220,28,3500,10,'Bạo Quyền',6011,21),
(612,'Vô Ảnh Cước',6,'active','none',232,30,3700,10,'Vô Ảnh Cước',6012,23),
(613,'Khí Công',6,'active','none',244,32,3900,10,'Khí Công',6013,25),
(614,'Né Đòn',6,'active','none',256,34,4100,10,'Né Đòn',6014,27),
(615,'Phản Đòn',6,'passive','none',0,0,0,10,'Phản Đòn',6015,1),
(616,'Hồi Khí',6,'passive','none',0,0,0,10,'Hồi Khí',6016,6),
(617,'Cương Thân',6,'passive','none',0,0,0,10,'Cương Thân',6017,11),
(618,'Mẫn Tiệp',6,'passive','none',0,0,0,10,'Mẫn Tiệp',6018,16),
(619,'Long Hổ Quyền',6,'ultimate','none',500,90,30000,10,'Long Hổ Quyền',6019,25),
(620,'Vô Cực Quyền',6,'ultimate','none',650,110,30000,10,'Vô Cực Quyền',6020,30),
(701,'Mưa Tên',7,'active','none',100,8,1500,10,'Mưa Tên',7001,1),
(702,'Tên Xuyên',7,'active','none',112,10,1700,10,'Tên Xuyên',7002,3),
(703,'Tên Lửa',7,'active','none',124,12,1900,10,'Tên Lửa',7003,5),
(704,'Bắn Nhanh',7,'active','none',136,14,2100,10,'Bắn Nhanh',7004,7),
(705,'Tên Băng',7,'active','none',148,16,2300,10,'Tên Băng',7005,9),
(706,'Tên Nổ',7,'active','none',160,18,2500,10,'Tên Nổ',7006,11),
(707,'Loạt Tên',7,'active','none',172,20,2700,10,'Loạt Tên',7007,13),
(708,'Tên Độc',7,'active','none',184,22,2900,10,'Tên Độc',7008,15),
(709,'Bẫy Chông',7,'active','none',196,24,3100,10,'Bẫy Chông',7009,17),
(710,'Tên Sét',7,'active','none',208,26,3300,10,'Tên Sét',7010,19),
(711,'Tên Xuyên Phá',7,'active','none',220,28,3500,10,'Tên Xuyên Phá',7011,21),
(712,'Mưa Sao',7,'active','none',232,30,3700,10,'Mưa Sao',7012,23),
(713,'Mắt Thần',7,'active','none',244,32,3900,10,'Mắt Thần',7013,25),
(714,'Ngắm Bắn',7,'active','none',256,34,4100,10,'Ngắm Bắn',7014,27),
(715,'Lăn Tránh',7,'passive','none',0,0,0,10,'Lăn Tránh',7015,1),
(716,'Áo Da',7,'passive','none',0,0,0,10,'Áo Da',7016,6),
(717,'Gió Thoảng',7,'passive','none',0,0,0,10,'Gió Thoảng',7017,11),
(718,'Sắc Bén',7,'passive','none',0,0,0,10,'Sắc Bén',7018,16),
(719,'Bão Tên',7,'ultimate','none',500,90,30000,10,'Bão Tên',7019,25),
(720,'Thần Tiễn',7,'ultimate','none',650,110,30000,10,'Thần Tiễn',7020,30),
(801,'Đâm Nhanh',8,'active','none',100,8,1500,10,'Đâm Nhanh',8001,1),
(802,'Ám Sát',8,'active','none',112,10,1700,10,'Ám Sát',8002,3),
(803,'Ném Dao',8,'active','none',124,12,1900,10,'Ném Dao',8003,5),
(804,'Chất Độc',8,'active','none',136,14,2100,10,'Chất Độc',8004,7),
(805,'Đâm Bóng',8,'active','none',148,16,2300,10,'Đâm Bóng',8005,9),
(806,'Hạ Sát',8,'active','none',160,18,2500,10,'Hạ Sát',8006,11),
(807,'Cắt Cổ',8,'active','none',172,20,2700,10,'Cắt Cổ',8007,13),
(808,'Độc Ngấm',8,'active','none',184,22,2900,10,'Độc Ngấm',8008,15),
(809,'Liên Đâm',8,'active','none',196,24,3100,10,'Liên Đâm',8009,17),
(810,'Bóng Tối',8,'active','none',208,26,3300,10,'Bóng Tối',8010,19),
(811,'Tử Huyệt',8,'active','none',220,28,3500,10,'Tử Huyệt',8011,21),
(812,'Vô Ảnh Sát',8,'active','none',232,30,3700,10,'Vô Ảnh Sát',8012,23),
(813,'Tàng Hình',8,'active','none',244,32,3900,10,'Tàng Hình',8013,25),
(814,'Tốc Độ',8,'active','none',256,34,4100,10,'Tốc Độ',8014,27),
(815,'Né Tránh',8,'passive','none',0,0,0,10,'Né Tránh',8015,1),
(816,'Phản Sát',8,'passive','none',0,0,0,10,'Phản Sát',8016,6),
(817,'Nhẹ Bước',8,'passive','none',0,0,0,10,'Nhẹ Bước',8017,11),
(818,'Sát Khí',8,'passive','none',0,0,0,10,'Sát Khí',8018,16),
(819,'Sát Thủ Ngầm',8,'ultimate','none',500,90,30000,10,'Sát Thủ Ngầm',8019,25),
(820,'Nhất Kích Tất Sát',8,'ultimate','none',650,110,30000,10,'Nhất Kích Tất Sát',8020,30);
...
('class_8','vi','Sat Thu','ui'),('class_8','en','Assassin','ui'),
-- HUD
