...
final class PacketWriter {
    ...
    static func charCreate(_ name: String, _ cls: Int, _ gen: Int) -> Data { PacketWriter(Op.C2S_CHAR_CREATE).writeString(name).writeInt(UInt32(cls)).writeByte(UInt8(gen)).build() }
